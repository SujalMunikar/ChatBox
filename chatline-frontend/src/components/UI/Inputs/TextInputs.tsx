...
// Text and password input primitives integrate cleanly with react-hook-form while showing validation errors.
    ...
    <label htmlFor={name} className="flex flex-col">
      ...
      <div className="flex-1  flex flex-col relative">
        <input
          ...
          {...register}
          {...rest}
          className="px-4 pr-12 py-2 flex-1 outline-none bg-transparent rounded-md border border-input-border-stationary active:border-input-border-primary focus:border-input-border-primary hover:border-input-border-primary leading-5"
        />
        <button
          type="button"
          className="absolute right-0 top-0 h-full px-3 text-lg"
          // Toggle between masked/visible mode without interfering with form submission.
          onClick={() => {
            setVisible(!visible);
          }}
        >
